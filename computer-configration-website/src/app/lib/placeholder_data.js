...
export const cpu = [
  ...
  {
    id: '12f4ab60-3c0f-4b8f-92ea-fdf02aa03e90',
    series: 'Intel Core i7',
    micro_architecture: 'Raptor Lake',
    core_family: 'Raptor Lake',
    core_count: 16,
    thread_count: 24,
    socket: 'LGA1700',
    performance_core_clock: 3.4,
    performance_core_boost_clock: 5.4,
    efficiency_core_clock: 2.5,
    efficiency_core_boost_clock: 4.2,
    l2_cache: 24,
    l3_cache: 30,
    tdp: 125,
    integrated_graphics: 'Intel UHD Graphics 770',
  ...
  {
    id: 'db42bc8e-a6d6-4ff1-b2f1-04fdf7991a2b',
    series: 'AMD Ryzen 5',
    micro_architecture: 'Zen 4',
    core_family: 'Raphael',
    core_count: 6,
    thread_count: 12,
    socket: 'AM5',
    performance_core_clock: 4.7,
    efficiency_core_boost_clock: 5.3,
    l2_cache: 6,
    l3_cache: 32,
    tdp: 105,
    integrated_graphics: 'Radeon 760M',
    max_supported_memory: 128,
    ecc_support: true,
    includes_cooler: false,
    packaging: 'Boxed',
  ...
  // Intel Core i3-13100 3.4 GHz 4-Core Processor
  {
    id: 'a834d5e4-1a84-4f94-9bb1-245a8e49bc15',
    ...
    socket: 'LGA1700',
    performance_core_clock: 3.4,
    performance_core_boost_clock: 4.5,
    efficiency_core_clock: null,
    efficiency_core_boost_clock: null,
    l2_cache: 5,
    l3_cache: 12,
    tdp: 60,
  ...
  {
    id: 'c3f9f051-0bb4-499b-bf2e-1bc095df749d',
    series: 'AMD Ryzen 9',
    micro_architecture: 'Zen 4',
    core_family: 'Raphael',
    core_count: 16,
    thread_count: 32,
    socket: 'AM5',
    performance_core_clock: 4.5,
    efficiency_core_boost_clock: 5.7,
    l2_cache: 16,
    l3_cache: 64,
    tdp: 170,
    integrated_graphics: 'Radeon 610M',
    max_supported_memory: 128,
    ecc_support: true,
    includes_cooler: false,
    packaging: 'Boxed',
  ...
  // Intel Core i9-13900KF 3.0 GHz 24-Core Processor
  {
    id: '9f8e14a7-56e3-4c9e-94df-5806b2c3d9f4',
    series: 'Intel Core i9',
    micro_architecture: 'Raptor Lake',
    core_family: 'Raptor Lake',
    core_count: 24,
    ...
    performance_core_boost_clock: 5.8,
    efficiency_core_clock: 2.2,
    efficiency_core_boost_clock: 4.3,
    l2_cache: 32,
    l3_cache: 36,
    tdp: 125,
    integrated_graphics: 'None',
...
export const motherboard = [
  ...
  {
    id: 'a2e78910-34e2-4a0c-9c12-d93a3b7a9827',
    cpu_socket: 'AM5',
    form_factor: 'ATX',
    chipset: 'AMD B650E',
    memory_max: 128,
    memory_type: 'DDR5',
    memory_slots: 4,
    memory_speed: 'DDR5-5200, DDR5-5600, DDR5-6000, DDR5-6400, DDR5-7200',
    color: 'Black',
    pcie_x16_slots: 2,
    pcie_x8_slots: 0,
    pcie_x4_slots: 1,
    pcie_x1_slots: 1,
    pci_slots: 0,
    m2_slots: 'M.2 PCIe 5.0 x4, M.2 PCIe 4.0 x4',
    mini_pcie_slots: 0,
    sata_6_0_gb_s: 4,
  ...
  {
    id: '2f3b69e1-5e0d-4d59-984b-3d2e14f917ec',
    cpu_socket: 'LGA1700',
    form_factor: 'ATX',
    chipset: 'Intel Z790',
    memory_max: 192,
    memory_type: 'DDR5',
    memory_slots: 4,
    memory_speed: 'DDR5-4800, DDR5-5200, DDR5-5600, DDR5-6000, DDR5-6400',
    color: 'Black / Silver',
    pcie_x16_slots: 2,
    pcie_x8_slots: 0,
    pcie_x4_slots: 1,
    pcie_x1_slots: 2,
    pci_slots: 0,
    m2_slots: 'M.2 PCIe 4.0 x4, M.2 PCIe 5.0 x4',
    mini_pcie_slots: 0,
    sata_6_0_gb_s: 4,
    onboard_ethernet: '1 x 2.5 Gb/s (Realtek)',
    onboard_video: 'Depends on CPU',
  ...
  {
    id: 'ec4d1cbf-c6a6-4a44-8d75-5e9c3e3ef1b8',
    cpu_socket: 'AM4',
    form_factor: 'Micro ATX',
    chipset: 'AMD B550',
    memory_max: 128,
    ...
    memory_slots: 4,
    memory_speed:
      'DDR4-3200, DDR4-3600, DDR4-4000, DDR4-4266, DDR4-4600, DDR4-5000',
    color: 'Black / Silver',
    pcie_x16_slots: 2,
    pcie_x8_slots: 0,
    pcie_x4_slots: 0,
    pcie_x1_slots: 2,
    pci_slots: 0,
    m2_slots: 'M.2 PCIe 3.0 x4, M.2 PCIe 4.0 x4',
    mini_pcie_slots: 0,
    sata_6_0_gb_s: 6,
    onboard_ethernet: '1 x 2.5 Gb/s (Realtek)',
    onboard_video: 'Depends on CPU',
...
export const memory = [
  ...
  // Kingston Fury Beast 32GB (2 x 16GB) DDR5-6000 CL36 Memory
  {
    id: 'b9730b16-bd37-46c5-9ef7-2a0f789d7a33',
    speed: 'DDR5-6000',
    form_factor: '288-pin DIMM (DDR5)',
    modules: '2 x 16GB',
    price_gb: 3.05,
  ...
  // Crucial Pro 64GB (2 x 32GB) DDR5-5600 CL46 Memory
  {
    id: 'c2f13b78-a1c8-4fb3-9a69-d2d8f7b5bcef',
    speed: 'DDR5-5600',
    form_factor: '288-pin DIMM (DDR5)',
    modules: '2 x 32GB',
    price_gb: 2.875,
    color: 'Black',
    first_word_latency: 14.5,
    cas_latency: 46,
    voltage: 1.25,
    timing: '46-46-46-90',
    ecc_registered: 'Non-ECC / Unbuffered',
  ...
  // Corsair Dominator Platinum RGB 32GB (2 x 16GB) DDR5-6600 CL32 Memory
  {
    id: 'd45f28c5-2a0b-4d86-bf5c-3a2dce6b4f93',
    speed: 'DDR5-6600',
    form_factor: '288-pin DIMM (DDR5)',
    modules: '2 x 16GB',
    price_gb: 3.75,
    color: 'Black',
    first_word_latency: 9.6,
    cas_latency: 32,
    voltage: 1.4,
    timing: '32-39-39-96',
    ecc_registered: 'Non-ECC / Unbuffered',
  ...
  // G.Skill Trident Z5 RGB 64GB (2 x 32GB) DDR5-7200 CL34 Memory
  {
    id: 'f12c0c9b-8f16-4e2c-8c6e-3bb27468907a',
    speed: 'DDR5-7200',
    form_factor: '288-pin DIMM (DDR5)',
    modules: '2 x 32GB',
    price_gb: 4.2,
    color: 'Silver',
    first_word_latency: 9.4,
    cas_latency: 34,
    voltage: 1.4,
    timing: '34-45-45-108',
    ecc_registered: 'Non-ECC / Unbuffered',
  ...
  // Patriot Viper Venom 16GB (2 x 8GB) DDR4-3600 CL18 Memory
  {
    id: 'a432b076-58fc-4854-95e1-07404ea1a217',
    speed: 'DDR4-3600',
  ...
  // Kingston Fury Renegade 32GB (2 x 16GB) DDR4-4000 CL19 Memory
  {
    id: 'b0b1de9a-7c8c-4db2-8779-cff3f98e91f0',
    speed: 'DDR4-4000',
    form_factor: '288-pin DIMM (DDR4)',
    modules: '2 x 16GB',
    price_gb: 2.85,
  ...
  // ADATA XPG Lancer 64GB (2 x 32GB) DDR5-6000 CL40 Memory
  {
    id: 'c982ef3e-5d6c-4666-9109-5c43f045a3eb',
    speed: 'DDR5-6000',
    form_factor: '288-pin DIMM (DDR5)',
    modules: '2 x 32GB',
    price_gb: 2.65,
    color: 'Black',
    first_word_latency: 11.5,
    cas_latency: 40,
    voltage: 1.35,
    timing: '40-42-42-92',
    ecc_registered: 'Non-ECC / Unbuffered',
...
export const storage = [
  ...
  // Western Digital Black SN850X 1TB M.2-2280 PCIe 4.0 X4 NVME Solid State Drive
  {
    id: 'b7e5fd13-2b21-4ad7-8e92-cb3f1f4086a6',
    capacity: 1024,
    price_per_gb: 0.085,
    type: 'SSD',
    form_factor: 'M.2-2280',
  ...
  // Sabrent Rocket 4 Plus 2TB M.2-2280 PCIe 4.0 X4 NVME Solid State Drive
  {
    id: 'fc4bba45-1e8e-4b66-946e-bfd834fca391',
    capacity: 2048,
    price_per_gb: 0.09,
    type: 'SSD',
    cache: 2048,
  ...
  // Seagate FireCuda 530 4TB M.2-2280 PCIe 4.0 X4 NVME Solid State Drive
  {
    id: '9e1bd62d-05ae-4bfa-a605-1a10c1a01336',
    capacity: 4096,
    price_per_gb: 0.11,
    type: 'SSD',
    cache: 4096,
  ...
  // Samsung 870 EVO 1TB 2.5" SATA Solid State Drive
  {
    id: 'cd52e1be-8d91-4f43-9f29-cfc24678a249',
    capacity: 1024,
    price_per_gb: 0.10,
    type: 'SSD',
    form_factor: '2.5"',
  ...
  {
    id: '7a4b4562-92f6-4a6d-bd5d-788ab42ff79c',
    capacity: 2048,
    price_per_gb: 0.09,
    type: 'SSD',
    form_factor: '2.5"',
  ...
  // Western Digital Blue SN570 500GB M.2-2280 PCIe 3.0 X4 NVME Solid State Drive
  {
    id: 'f362d573-935f-4e51-9a5f-7915d1e3c4f1',
    capacity: 500,
    price_per_gb: 0.07,
    type: 'SSD',
    form_factor: 'M.2-2280',
  ...
  {
    id: 'de5f6b89-7241-4a4c-b3f3-4082a8eac87c',
    capacity: 4096,
    price_per_gb: 0.03,
    type: 'HDD',
    form_factor: '3.5"',
  ...
  // Seagate BarraCuda 8TB 3.5" 5400RPM Internal Hard Drive
  {
    id: 'c9d4e8b6-6f79-41d1-81b4-5084768c3a71',
    capacity: 8192,
    price_per_gb: 0.02,
    type: 'HDD',
    form_factor: '3.5"',
  ...
  // Western Digital Red Pro 12TB 3.5" 7200RPM Internal Hard Drive
  {
    id: '5eac7f23-6e36-49f6-bc6e-6db8d8f82a47',
    capacity: 12288,
    price_per_gb: 0.04,
    type: 'HDD',
    form_factor: '3.5"',
